namespace Tree.Tests
{
    ...
    public class TreeTests
    {
        ...
        [Test]
        public void TestAddChildSubtreeWorksCorrectlyParent1()
        {
        ...
        [Test]
        public void TestAddChildSubtreeWorksCorrectlyparent19()
        {
            tree.AddChild(19, new Tree<int>(-1, new Tree<int>(-2), new Tree<int>(-3)));
            int[] expected = { 1, 12, 31, -2, -3, -1, 19, 21, 23, 6, 14, 7 };
            int index = 0;
            var traversedTree = tree.OrderDfs();
            foreach (int num in traversedTree)
            {
        ...
        [Test]
        public void TestAddChildSubtreeWorksCorrectlyparent19_1_2_3()
        {
            tree.AddChild(19, new Tree<int>(101, new Tree<int>(102, new Tree<int>(103))));
            tree.AddChild(102, new Tree<int>(104));
            int[] expected = { 1, 12, 31, 103, 104, 102, 101, 19, 21, 23, 6, 14, 7 };
            int index = 0;
            var traversedTree = tree.OrderDfs();
            foreach (int num in traversedTree)
            {
        ...
        [Test]
        public void TestRemoveParentWorksCorrectlyAfterAddingNewRoot()
        {
            int[] expected = { };
            tree.RemoveNode(7);
