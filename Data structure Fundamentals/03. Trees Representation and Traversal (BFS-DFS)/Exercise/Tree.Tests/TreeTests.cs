namespace Tree.Tests
{
    ...
    public class TreeTests
    {
        ...
        [Test]
        public void TreeDeepestLeftmostNodeShouldWorkCorrectlyNewTest()
        {
            string[] input = new string[]
            {
                "7 19",
            ...
            Tree<int> deepestNode = tree.GetDeepestLeftomostNode();

            Assert.AreEqual(77, deepestNode.Key);
        }
        ...
        [Test]
        public void TreePathsWithGivenSumShouldWorkCorrectlySecondTest()
        {
            string[] input = new string[]
            {
                "7 19",
            ...
            List<List<int>> paths = tree.PathsWithGivenSum(59);
