namespace _03.PriorityQueue
{
        ...
        where T : IComparable<T>
    {
        ...
        private void HeapifyDown()
        {
            ...
            while (this.IndexIsValid(leftChildIndex) && this.IsLess(parentIndex, leftChildIndex))
            {
                var toSwap = leftChildIndex;
                var rightChildIndex = GetRightChildIndex(parentIndex);
                if (this.IndexIsValid(rightChildIndex) && this.IsLess(toSwap, rightChildIndex))
                {
        ...
        private void HeapifyUp()
        {
            ...
            while (currentIndex > 0 && IsGreater(currentIndex, parentIndex))
            {
